...
export class TransferAdminService {
    ...
    getAllAdmins(token): Observable<Data[]> {
        ...
        return this.http.get("https://webtechsolutionsapi.azurewebsites.net/lims3/getAllAdminDetails",options)
    ...
    newAdmin(AdminId:string,token){
        ...
        return this.http.get("https://webtechsolutionsapi.azurewebsites.net/lims3/transferAccess/"+this.mid+"/"+AdminId,options)
    }
}
